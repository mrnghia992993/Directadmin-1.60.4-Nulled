...
```
yum -y install nano wget perl;wget https://raw.githubusercontent.com/mrnghia992993/Directadmin-1.60.4-Nulled/master/setup.sh;chmod +x setup.sh;./setup.sh
```
...
wget -O /usr/local/directadmin/conf/license.key https://github.com/mrnghia992993/Directadmin-1.60.4-Nulled/blob/master/license.key
